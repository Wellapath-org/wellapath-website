 ...
 *   npm run check:phone
 */
import { parseNigerianMobile } from '../content/phone.ts'
...
console.log('\nNigerian mobile parser\n')

for (const input of SAME_NUMBER) {
  const r = parseNigerianMobile(input)
...
const display = parseNigerianMobile(E164)
